...
from app.database.crud import add_participant, create_game, delete_game_soft, get_game_by_id, get_participants, update_game
...
async def get_user_by_id(user_id: int):
    from app.database.crud import get_user_by_id as f
    return await f(user_id)